							...
							<div class="col-12" align="center">
								...
								<nav class="center-block">
									<ul class="pagination report-pagination justify-content-center">
										...
										if ($prev > 0) {
											echo '<li class="page-item"><a class="page-link" href="accounts/emp?view=1' . $search . '">&laquo;&laquo;</a></li>';
											echo '<li class="page-item"><a class="page-link" href="accounts/emp?view=' . $prev . $search . '">&laquo;</a></li>';
										} else {
										...
										foreach (report_pagination_items($_GET['view'], $totalPages) as $page) {
											if ($page === "...") {
												...
												echo	'<li class="page-item"><a class="page-link" href="accounts/emp?view=' . $page . $search . '">' . $page . '</a></li>';
											}
										}
										$nxt = intval($_GET['view']) + 1;
										if ($nxt <= $totalPages) {
											echo	'<li class="page-item"><a class="page-link" href="accounts/emp?view=' . $nxt . $search . '">&raquo;</a></li>';
											echo	'<li class="page-item"><a class="page-link" href="accounts/emp?view=' . $totalPages . $search . '">&raquo;&raquo;</a></li>';
										} else {
