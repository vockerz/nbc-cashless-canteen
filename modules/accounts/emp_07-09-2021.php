...
<?php
	...
	if(isset($_POST['update'])){
		if(!empty($_POST['fname']) && !empty($_POST['mname']) && !empty($_POST['lname']) && !empty($_POST['emp_no']) && !empty($_POST['section'])){
			...
			$_POST['department'] = strtoupper($_POST['department']);
			$_POST['position'] = strtoupper($_POST['position']);
			$stmt = $conn->prepare("UPDATE members SET type = ?, fname = ?, mname = ?, lname = ?, address = ?, department = ?, position = ?, emp_no = ?, section = ?	where member_id = ?");
			$stmt->bind_param("sssssssssi", $_POST['type'], $_POST['fname'], $_POST['mname'], $_POST['lname'], $_POST['address'], $_POST['department'], $_POST['position'], $_POST['emp_no'], $_POST['section'], $_SESSION['edit_id']);
			if($stmt->execute() === TRUE){
