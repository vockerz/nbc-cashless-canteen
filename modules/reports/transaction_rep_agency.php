...
<div class="content mt-3">
	<div class="animated fadeIn">
		<div class="row">
			<div class="col-lg-12">
				<form action="reports/transaction_rep_agency" method="get">
					<div class="card">
				...
				<?php
					...
					if(isset($_GET['date_fr']) && isset($_GET['date_to'])){
						...
						$whereSql = " FROM transactions as a LEFT JOIN members as b on a.rfid_no = b.rfid_no WHERE b.type = 'Agency' and a.isload = 1 and a.dttm BETWEEN '" . $date_fr . $shift_fr . "' and '" . $date_to . $shift_to . "' and a.product_id NOT IN (1,2) and a.active IN (0,2) ";
						...
						<div class="card">			
							...
							<div class="card-body">
								...
								<?php if(!isset($_GET['print']) && $totalPages > 1){
									...
									$basePageUrl = 'reports/transaction_rep_agency?date_fr=' . urlencode($_GET['date_fr']) . '&date_to=' . urlencode($_GET['date_to']) . '&shift=' . urlencode($shiftVal) . '&submit=';
