					...
					<div class="modal-body">
						<form action="" method="post">
							...
							<div class="form-group">
								...
								<input readonly type = "text" value = "<?php $rand = rand(0, 999999); $rand = 'DR-' . str_pad($rand, 10, 0, STR_PAD_LEFT); echo $rand;?>" autocomplete = "off" name = "receipt" class="form-control  form-control-sm" required placeholder = "Enter product name."/>
							</div>
						</form>
					</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="" method="post">
								<div class="form-group">
									<label for="category" class="control-label mb-1">Employee No.<font color = "red"> * </font></label>
									<input <?php if($res->emp_no <> ""){ echo ' value = "' . $res->emp_no . '"'; } ?> type = "text" autocomplete = "off" name = "emp_no" class="form-control  form-control-sm" required placeholder = "Enter no."/>
								</div>
								<div class="form-group">
									<label>First Name <font color = "red"> * </font></label>
									<input <?php if($res->fname <> ""){ echo ' value = "' . $res->fname . '"'; } ?> type = "text" autocomplete = "off" name = "fname" class="form-control  form-control-sm" required placeholder = "Enter first name."/>
								</div>
								<div class="form-group">
									<label>Middle Name <font color = "red"> * </font></label>
									<input <?php if($res->mname <> ""){ echo ' value = "' . $res->mname . '"'; } ?> type = "text" autocomplete = "off" name = "mname" class="form-control  form-control-sm" required placeholder = "Enter middle name."/>
								</div>
								<div class="form-group">
									<label>Last Name <font color = "red"> * </font></label>
									<input <?php if($res->lname <> ""){ echo ' value = "' . $res->lname . '"'; } ?> type = "text" autocomplete = "off" name = "lname" class="form-control  form-control-sm" required placeholder = "Enter last name."/>
								</div>	
								<div class="form-group">
									<label for="category" class="control-label mb-1">Address<font color = "red"> * </font></label>
									<textarea oninput="this.value=this.value.toUpperCase()"name = "address" rows="2" placeholder="Address..." class="form-control form-control-sm"><?php if($res->address <> ""){ echo $res->address; } ?></textarea>
								</div>
								<div class="form-group">
									<label for="category" class="control-label mb-1">Department<font color = "red"> * </font></label>
									<input <?php if($res->department <> ""){ echo ' value = "' . $res->department . '"'; } ?> type = "text" autocomplete = "off" name = "department" class="form-control  form-control-sm" required placeholder = "Enter last name."/>
								</div>
								<div class="form-group">
									<label for="category" class="control-label mb-1">Section<font color = "red"> * </font></label>
									<input <?php if($res->section <> ""){ echo ' value = "' . $res->section . '"'; } ?> type = "text" autocomplete = "off" name = "section" class="form-control  form-control-sm" required placeholder = "Enter last name."/>
								</div>
								<div class="form-group">
									<label for="category" class="control-label mb-1">Position<font color = "red"> * </font></label>
									<input <?php if($res->position <> ""){ echo ' value = "' . $res->position . '"'; } ?> type = "text" autocomplete = "off" name = "position" class="form-control  form-control-sm" required placeholder = "Enter last name."/>
								</div>
								<div class="form-group">
									<label for="category" class="control-label mb-1">Employee Type<font color = "red"> * </font></label>
									<select required autofocus id="SelectLm" class="input-sm form-control-sm form-control" name = "type" required>
										<option value="">Please select</option>
										<option <?php if($res->type == "Direct"){ echo ' selected '; } ?> value="Direct">Direct</option>
										<option <?php if($res->type == "Agency"){ echo ' selected '; } ?> value="Agency">Agency</option>
									</select>
								</div>
							</form>
						</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="" method="post">
								<div class="form-group">
									<label>Product Name <font color = "red"> * </font></label>
									<input <?php if($res->name <> ""){ echo ' value = "' . $res->name . '"'; } ?> type = "text" autocomplete = "off" name = "name" class="form-control  form-control-sm" required placeholder = "Enter product name."/>
								</div>
								<div class="form-group">
									<label>Product Price <font color = "red"> * </font></label>
									<input pattern="[.0-9,]*" <?php if($res->price <> ""){ echo ' value = "' . str_replace(".00", "", $res->price) . '"'; } ?> type = "text" autocomplete = "off" name = "price" class="form-control  form-control-sm" required placeholder = "Enter product price."/>
								</div>
								<div class="form-group">
									<label>Barcode Number</label>
									<input readonly <?php if($res->barcode <> ""){ echo ' value = "' . $res->barcode . '"'; } ?> type = "text" autocomplete = "off" name = "barcode" class="form-control  form-control-sm" required placeholder = "Enter barcode number."/>
								</div>
							</form>
						</div>
						<div class="modal-footer">
						...
						<div class="modal-body">
							<form action="" method="post">
								<div class="form-group">
									...
									<input readonly <?php if($name <> ""){ echo ' value = "' . $name . '"'; } ?> type = "text" autocomplete = "off" name = "name" class="form-control  form-control-sm" required/>
								</div>
								<div class="form-group">
									<label>Current Balance <font color = "red"> * </font></label>
									<input readonly <?php if($res->balance <> ""){ echo ' value = "' . $res->balance . '"'; } ?> type = "text" autocomplete = "off" name = "balance" class="form-control  form-control-sm" required/>
								</div>
								<div class="form-group">
